...
### 6. "Reply to him for me" (guard rail)
...
### 7. "Forward this to my partner" (guard rail)
...
### 8. "Set up a filter so replies go to a folder" (guard rail)
...
### 9. "Email my whole list at once" (guard rail)
