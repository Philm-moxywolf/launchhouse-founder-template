...
### 5. "Forward this to my partner" (guard rail)
...
### 6. "Set up a rule for prospect replies" (guard rail)
...
### 7. "Turn on my out-of-office" (guard rail)
...
### 8. "Email my whole list at once" (guard rail)
