...
|---|---|---|
| No GoHighLevel tools appear after connecting | The account connector session did not finish, or needs a fresh conversation to pick it up | Disconnect and reconnect **HighLevel** in Settings, then Connectors; start a new conversation in this folder. |
