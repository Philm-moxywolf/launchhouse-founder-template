...
### 4. Refusal: starting the sequence
...
### 5. Refusal: enrichment with no yes
...
### 10. Someone asks to be left alone
...
### 11. A first message the founder wants sent to a new contact
