...
The clinic is the session where the snapshot is loaded and the links above are pasted in. Its date, and every other programme date, is in `.claude/references/gates.md`, in one block. Do not repeat a date here.
